...
public final class Resources {
    ...
    private static void defaultMedicines() {
        medicines.clear();
        Medicine medicine1 = new Medicine("Ibuprofen", Presentation.SYRUP, "human", "64ml", 25, 250);
        Medicine medicine2 = new Medicine("Soloxiner", Presentation.PILLS, "veterinarian", "25g", 10, 125);
        Medicine medicine3 = new Medicine("Antiworms", Presentation.SYRUP, "human", "25g", 15, 396);
        Medicine medicine4 = new Medicine("Heartgard", Presentation.PET_CARE, "veterinarian", "100g", 42, 500);
